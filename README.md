...
*   **Frameworks & Libraries:** Symfony, Drupal (7, 8, 9, 10, 11), jQuery, React JS
...
### Software Development Engineer | ASYNC life, Ukraine
*August 2024 – June 2026*

**Project:** A large-scale Austrian digital news platform that delivers breaking news, premium journalism, multimedia content, and subscription services. The portal supports high-volume content publishing through editorial workflows, category and taxonomy management, search, multimedia assets, user accounts, premium content, and advertising integrations while handling significant daily traffic and continuous content updates.

*   Developed and maintained custom Drupal modules to support editorial workflows and business-specific functionality.
*   Designed and implemented custom Drupal entities and backend APIs to manage structured content and integrate with external services.
*   Participated in the migration of the platform from Drupal 10 to Drupal 11, ensuring module compatibility, dependency updates, and a smooth transition with minimal disruption.
*   Built and maintained REST APIs for communication between Drupal and external applications, including headless frontend components.
*   Contributed to the platform's headless Drupal architecture, enabling content delivery to decoupled frontend applications.
*   Optimized search performance by configuring and tuning Elasticsearch, improving indexing quality and search relevance.
*   Improved application performance through effective use of Varnish caching and Drupal's caching mechanisms.
*   Integrated and maintained multimedia storage using AWS S3, enabling scalable management and delivery of images and other media assets.
*   Wrote and maintained Behat functional tests and PHPUnit unit tests to improve application reliability and support continuous integration.
*   Investigated and resolved production issues, optimized backend performance, and collaborated closely with frontend developers, QA engineers, and product stakeholders.
*   Participated in code reviews, contributed to architectural discussions, and followed Drupal coding standards and best practices.

**Technologies Used:** Drupal 10/11, PHP, Symfony Components, MySQL, Elasticsearch, AWS S3, REST API, Headless Drupal, Varnish Cache, PHPUnit, Behat, Composer, Git, Docker, CI/CD.
